...
2. Build, Execute Shell:
	<tt>
		#!/bin/bash -xl<br />
		\curl -sSL get.rvm.io | bash -s stable –ruby=1.9.3 source /var/lib/jenkins/.rvm/scripts/rvm<br />
		source /var/lib/jenkins/.rvm/scripts/rvm<br />
		rvm use gemset actionman<br />
		bundle install<br />
		export DB_USERNAME=<db_username><br />
		export DB_PASSWORD=<db_password><br />
		RAILS_ENV=test bundle exec rake
	</tt>

=== Install Dependencies

1. Install db/mysql: sudo apt-get install mysql-server mysql-client libmysqlclient-dev.
