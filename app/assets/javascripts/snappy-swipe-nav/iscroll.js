...
iScroll.prototype = {
	...
	handleEvent: function (e) {
		...
		switch(e.type) {
			case START_EV:
				if (e.target.nodeName.toLowerCase() == "select" || e.target.tagName.toLowerCase() == 'input' || e.target.tagName.toLowerCase() == 'textarea' || e.target.tagName.toLowerCase() == 'a') return;
